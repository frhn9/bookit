    ...
    public static Specification<User> getSpecification(UserSearchDto userSearchDto){
        return new Specification<User>() {
            ...
            public Predicate toPredicate(Root<User> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
                ...
                if(!(userSearchDto.getSearchJob() == null)){
                    Predicate customerJobPredicate = criteriaBuilder.like(criteriaBuilder.lower(root.get("job")),
                            "%"+userSearchDto.getSearchAddress().toLowerCase(Locale.ROOT)+"%");
                    predicates.add(customerJobPredicate);
                }
